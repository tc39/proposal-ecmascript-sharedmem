...
\begin{frame}[plain]
  ...
  \note{The rest of the presentation are not planned to be presented as it is unlikely a good use of committee time to go into the actual math. Nevertheless, they may be valuable for folks who are reading the slides and are interested in some of the math without going down the rabbit hole.}
\end{frame}
